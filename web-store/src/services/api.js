...
const API_URL = import.meta.env.DEV ? '' : ((import.meta.env.VITE_API_URL || 'http://localhost:4000').replace(/\/api\/?$/, '') || '')
export const IMG_BASE = import.meta.env.DEV ? '' : (import.meta.env.VITE_API_URL || 'http://localhost:4000').replace(/\/api\/?$/, '') || ''
